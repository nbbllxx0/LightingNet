...
from layers import unetConv2,DUpsampling

from Architecture import VITsubnet, Decoder
...
class Res2Net(nn.Module):
    ...
    def forward(self, x):
        ...
        xout = self.layer3(x_layer2)  # x16


        return xout, x_layer1, x_layer2
...
class Encoder(nn.Module):
    ...
    def forward(self, input):
        xout, x_layer1, x_layer2= self.encoder(input)
...
#
        self.feature_extract1 = Encoder(imagenet_model)

        self.feature_extract2 = Decoder()
#
        self.VIT = VITsubnet()
#
        self.conv_2 = nn.Conv2d(in_channels=168, out_channels=3, kernel_size=1)
#
